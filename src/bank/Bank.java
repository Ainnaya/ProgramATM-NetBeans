    ...
    public static void main(String[] args) {
        ...
        try {
            do {
                ...
                {
                    do {
                        str = JOptionPane.showInputDialog(null, "[1] INFORMATION SALDO \n[2] PENYETORAN \n[3] PENARIKAN \n[4] PETUNJUK \n[5] KELUAR \n\n Masukkan Pilihan Menu:", "Pilih Transaksi", 3);
                        ...
                        switch (choice) {
                            case 1:
                                ...
                                case3:
                                str1 = JOptionPane.showInputDialog(null, "Memasukkan jumlah penarikan : "); //pengambilan
                                t = Integer.parseInt(str1);
                                tarik mengambil = new tarik();
                                mengambil.ambil(tab, t);
                                tab = mengambil.getsaldo();
                                z = JOptionPane.showConfirmDialog(null, "Melanjutkan ransaksi lain?", "ATM BNI SYARIAH-BOJONEGORO", JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain
                                if (z == 0) {
                                    break;
                                } else {
                                    JOptionPane.showMessageDialog(null, "Terimakasih telah menggunakan ATM BRI, ambil kartu ATM Anda.");
                            ...
                            case 5:
                                ...
                                if (z == 0) {
                                    JOptionPane.showMessageDialog(null, "Terimakasih telah mengunakan ATM BRI, ambil kartu ATM Anda");
                                    System.exit(0);
                                } else {
                                    break;
                                }
                    ...
                    JOptionPane.showMessageDialog(null, "\nKessempatan login " + a + " kali lagi" + "\n");
                } else {
                    JOptionPane.showMessageDialog(null, "Untuk bantuan nasabah,\nsilahkan menghubungi call center 55123 (Gratis)", "Kartu ATM anda diblokir,", 0);
                    System.exit(0);
                }
            } while (1 == 1);
